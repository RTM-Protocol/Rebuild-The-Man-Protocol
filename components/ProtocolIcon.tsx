  ...
  return (
    <svg className={svgBase} viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx={12} cy={14} r={1.2} stroke="currentColor" strokeWidth={1.5} />
    </svg>
  );
}
  ...
  return (
    <svg className={svgBase} viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx={16.25} cy={9.75} r={1.15} stroke="currentColor" strokeWidth={1.5} />
      <path
  ...
  return (
    <svg className={svgBase} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx={12} cy={13.75} r={6.75} stroke="currentColor" strokeWidth={2} />
      <path
...
export default function ProtocolIcon({ protocolId }: { protocolId: string }) {
  switch (protocolId) {
    case 'rebuild-the-man':
      return <BrandShieldIcon />;
    case 'pressure-valve':
      return <PressureGaugeIcon />;
    case 'system-overload':
      return <CircuitBreakerIcon />;
    case 'engine-restart':
      return <PowerIgnitionIcon />;
    case 'calibration-protocol':
      return <SpiritLevelIcon />;
    default: {
